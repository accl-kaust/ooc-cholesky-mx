 ...
 **/
int PLASMA_dgeadd(PLASMA_enum trans, int M, int N, double alpha, double *A, int LDA, double beta, double *B, int LDB);
...
int PLASMA_dlascal(PLASMA_enum uplo, int M, int N, double alpha, double *A, int LDA);
...
int PLASMA_dpotrf_gpu_dist(PLASMA_enum uplo, int N, double *A, int LDA);
#endif
#ifdef PLASMA_WITH_HPCASIA24
#ifdef PLASMA_WITH_CUDA
int PLASMA_dpotrf_gpu_async_copy_mixed_precision(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_mixed_precision(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_table_mixed_precision(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_mixed_precision(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_mixed_precision_dist(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_table_mixed_precision_dist(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_mixed_precision_dist(PLASMA_enum uplo, int N, double *A, int LDA);
#endif
#endif
...
int PLASMA_dsyrk(PLASMA_enum uplo, PLASMA_enum trans, int N, int K, double alpha, double *A, int LDA, double beta, double *C, int LDC);
int PLASMA_dsyr2k(PLASMA_enum uplo, PLASMA_enum trans, int N, int K, double alpha, double *A, int LDA, double *B, int LDB, double beta, double *C, int LDC);
int PLASMA_dtradd(PLASMA_enum uplo, PLASMA_enum trans, int M, int N, double alpha, double *A, int LDA, double beta, double *B, int LDB);
 ...
 **/
int PLASMA_dgeadd_Tile(PLASMA_enum trans, double alpha, PLASMA_desc *A, double beta, PLASMA_desc *B);
...
int PLASMA_dlascal_Tile(PLASMA_enum uplo, double alpha, PLASMA_desc *A);
...
int PLASMA_dpotrf_gpu_dist_Tile(PLASMA_enum uplo, PLASMA_desc *A);
#endif
#ifdef PLASMA_WITH_HPCASIA24
#ifdef PLASMA_WITH_CUDA
int PLASMA_dpotrf_gpu_async_copy_Tile(PLASMA_enum uplo, PLASMA_desc *A);
...
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_Tile(PLASMA_enum uplo, PLASMA_desc *A);
int PLASMA_dpotrf_gpu_reuse_data_table_no_free_Tile(PLASMA_enum uplo, PLASMA_desc *A);
int PLASMA_dpotrf_gpu_reuse_data_static_table_Tile(PLASMA_enum uplo, PLASMA_desc *A);
int PLASMA_dpotrf_gpu_reuse_data_dist_Tile(PLASMA_enum uplo, PLASMA_desc *A);
int PLASMA_dpotrf_gpu_reuse_data_table_dist_Tile(PLASMA_enum uplo, PLASMA_desc *A);
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_dist_Tile(PLASMA_enum uplo, PLASMA_desc *A);
int PLASMA_dpotrf_gpu_reuse_data_table_no_free_dist_Tile(PLASMA_enum uplo, PLASMA_desc *A);
int PLASMA_dpotrf_gpu_reuse_data_static_table_dist_Tile(PLASMA_enum uplo, PLASMA_desc *A);
#endif
#endif
...
int PLASMA_dsyrk_Tile(PLASMA_enum uplo, PLASMA_enum trans, double alpha, PLASMA_desc *A, double beta, PLASMA_desc *C);
int PLASMA_dsyr2k_Tile(PLASMA_enum uplo, PLASMA_enum trans, double alpha, PLASMA_desc *A, PLASMA_desc *B, double beta, PLASMA_desc *C);
int PLASMA_dtradd_Tile(PLASMA_enum uplo, PLASMA_enum trans, double alpha, PLASMA_desc *A, double beta, PLASMA_desc *B);
 ...
 **/
int PLASMA_dgeadd_Tile_Async(PLASMA_enum trans, double alpha, PLASMA_desc *A, double beta, PLASMA_desc *B, PLASMA_sequence *sequence, PLASMA_request *request);
...
int PLASMA_dlascal_Tile_Async(PLASMA_enum uplo, double alpha, PLASMA_desc *A, PLASMA_sequence *sequence, PLASMA_request *request);
...
int PLASMA_dpotrf_gpu_dist_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A, PLASMA_sequence *sequence, PLASMA_request *request);
#endif
#ifdef PLASMA_WITH_HPCASIA24
#ifdef PLASMA_WITH_CUDA
int PLASMA_dpotrf_gpu_reuse_data_mixed_precision_Tile_Async(PLASMA_enum uplo, MixedPrecisionTiledArray *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_table_mixed_precision_Tile_Async(PLASMA_enum uplo, MixedPrecisionTiledArray *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_mixed_precision_Tile_Async(PLASMA_enum uplo, MixedPrecisionTiledArray *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_mixed_precision_dist_Tile_Async(PLASMA_enum uplo, MixedPrecisionTiledArray *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_table_mixed_precision_dist_Tile_Async(PLASMA_enum uplo, MixedPrecisionTiledArray *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_mixed_precision_dist_Tile_Async(PLASMA_enum uplo, MixedPrecisionTiledArray *A, PLASMA_sequence *sequence, PLASMA_request *request);
void plasma_pdpotrf_gpu_reuse_data_mixed_precision (plasma_context_t *plasma);
void plasma_pdpotrf_gpu_reuse_data_table_mixed_precision (plasma_context_t *plasma);
void plasma_pdpotrf_gpu_reuse_data_table_all_managed_mixed_precision (plasma_context_t *plasma);
void plasma_pdpotrf_gpu_reuse_data_mixed_precision_quark(PLASMA_enum uplo, MixedPrecisionTiledArray A, PLASMA_sequence *sequence, PLASMA_request *request);
void plasma_pdpotrf_gpu_reuse_data_table_mixed_precision_quark(PLASMA_enum uplo, MixedPrecisionTiledArray A, PLASMA_sequence *sequence, PLASMA_request *request);
void plasma_pdpotrf_gpu_reuse_data_table_all_managed_mixed_precision_quark(PLASMA_enum uplo, MixedPrecisionTiledArray A, PLASMA_sequence *sequence, PLASMA_request *request);
void plasma_pdpotrf_gpu_reuse_data_mixed_precision_dist (plasma_context_t *plasma);
void plasma_pdpotrf_gpu_reuse_data_table_mixed_precision_dist (plasma_context_t *plasma);
void plasma_pdpotrf_gpu_reuse_data_table_all_managed_mixed_precision_dist (plasma_context_t *plasma);
void plasma_pdpotrf_gpu_reuse_data_mixed_precision_dist_quark(PLASMA_enum uplo, MixedPrecisionTiledArray A, PLASMA_sequence *sequence, PLASMA_request *request);
void plasma_pdpotrf_gpu_reuse_data_table_mixed_precision_dist_quark(PLASMA_enum uplo, MixedPrecisionTiledArray A, PLASMA_sequence *sequence, PLASMA_request *request);
void plasma_pdpotrf_gpu_reuse_data_table_all_managed_mixed_precision_dist_quark(PLASMA_enum uplo, MixedPrecisionTiledArray A, PLASMA_sequence *sequence, PLASMA_request *request);
#endif
#endif
